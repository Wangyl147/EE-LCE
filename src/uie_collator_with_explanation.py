...
#将instruction和文本组装起来形成输入,但是加上了explanation
'''
'Please tell me event type and its trigger word from given type options. Output format is "type: trigger". Option: declare bankruptcy, transfer ownership, marry, die, phone write, arrest jail, convict, sue, transfer money, end organization, start organization, end position, merge organization, start position, transport, charge indict, elect, attack, injure, born, extradite, release parole, sentence, demonstrate, meet, trial hearing, divorce, nominate, fine, appeal, pardon, execute, acquit Text: I just talked to somebody from <unk> LA a couple days ago about that on the -- survey line. Answer:</s><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad>'
'''

'''
{'id': '0', 
'sentence': 'OBJECTIVE: To test the hypothesis that tumor necrosis factor (TNF)-alpha may mediate the loss and the dedifferentiation of subcutaneous fat tissue in the insulin-induced lipoatrophies of a diabetic patient who presented extensive lesions.', 
'label': ' adverse event: induced ', 
'instruction': 'Please tell me event type and its trigger word from given type options. Output format is "type: trigger".  Option: adverse event, potential therapeutic event \nText: {0} \nAnswer:', 
'ground_truth': ' adverse event: induced '}
'''
'''
{'Task': 'EE',
'Dataset': 'CASIE',
...
'Instance': {
    'id': '3750', 
    'sentence': 'According to a Booz Allen analysis , spear - phishing emails containing weaponized Microsoft Word , Excel , and PowerPoint files , exactly the type of files typically found on laptop computers , were sent to Ukraine electric utility employees as early as May 2014 .',
    'label': ' ( phishing: were sent to,  May 2014: time, Ukraine electric utility employees: victim, spear - phishing emails: tool) ',
    'instruction': 'Locate the role in the text that participated in the event based on the event type and return it in the event list. \n Option: Event type: phishing, data breach, ransom, discover vulnerability, patch vulnerability, Arguments type: vulnerable system, capabilities, vulnerability, number of victim, issues addressed, compromised data, damage amount, common vulnerabilities and exposures, victim, patch number, number of data, tool, discoverer, time, purpose, place, payment method, releaser, vulnerable system version, attacker, supported platform, patch, price, vulnerable system owner, trusted entity, attack pattern. \nText: {0} \nAnswer:',
    'ground_truth': ' ( phishing: were sent to,  May 2014: time, Ukraine electric utility employees: victim, spear - phishing emails: tool) '
    }
}
'''
